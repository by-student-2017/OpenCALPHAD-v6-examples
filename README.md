...
- As written in the "Note" section below, discussing retention is impossible unless the organization is also considered. The phase field method is used to understand the relationship between tissue and magnetism.
...
- Note 4: Retention force cannot be obtained unless Nd is precipitated at a reasonably high concentration at the grain boundaries (2-3 nm width).
