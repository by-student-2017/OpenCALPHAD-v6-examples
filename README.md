...
- Note 2: Academic research often requires high accuracy, but when confirming results with actual experiments, it is sufficient to obtain systematic (qualitative or semi-quantitative) results through simulation. When developing materials, be sure to consider the required accuracy and cost. Is your company's product development expensive, time-consuming, and requires academic-level precision ? In development, obtaining a relative value at a lower cost is better than getting an absolute value at a higher price. Please think carefully about whether it is necessary to create a neural network potential that is unstable in a four-element system or higher, which costs a lot of money.
...
- If you only need ternary phase diagrams, pycalphad is recommended. It is very unfortunate that in the current state of development (pycalphad), it is not possible to draw a ternary system phase diagram by fixing other elements such as a quaternary system.
