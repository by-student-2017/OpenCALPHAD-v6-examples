...
- As written in the "Note" section below, discussing the coercivity is impossible unless the organization is also considered. The phase field method is used to understand the relationship between tissue and magnetism.
