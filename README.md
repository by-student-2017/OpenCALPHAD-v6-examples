...
## R-Fe-Nb
- Since there is no official answer from the main company, I am preparing this as a test. I think it's worth using demo versions of Pandat and other commercial software if they match up roughly.
